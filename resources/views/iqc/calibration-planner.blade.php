...
@section('content')
    ...
    <head>
        ...
        <title>Calibration Calendar</title>
    ...
    <body>
        <div class="main ">
            <div class="d-flex align-items-center justify-content-between gap-3 tr-second-nav px-3 py-2 heading mb-4">
                <div style="font-size: 20px;">Calibration Calendar</div>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKUFG6Vc5a-GdBOYheGswae-H7Cp7cVzA&libraries=places"></script>
