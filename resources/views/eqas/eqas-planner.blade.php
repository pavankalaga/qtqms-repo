...
@section('content')
    ...
    <body>
        <div class="main ">
            <div class="d-flex align-items-center justify-content-between gap-3 tr-second-nav px-3 py-2 heading mb-4">
                <div style="font-size: 20px;">EQAS Planner</div>
            ...
            <tr>
                ...
                <td><input type="text" class="month-datepicker" data-month="11" name="eqas[0][dates][Dec]"></td>
                        ...
                        <div class="eqas-add-new">
                            <button type="button" id="add-row-button">Add New EQAS</button>
                        </div>
    ...
    <script>
        ...
        function populateTable(data) {
            ...
            console.log(data, 'data populate')

            const departmentOptions = `{!! collect($departs)->map(function ($department) {
        return "<option value='" . e($department->id) . "'>" . e($department->name) . "</option>";
    })->implode('') !!}`;
            ...
            data.forEach((item, index) => {
                ...
                ${generateNameDropdown(index, item.eqas_name)}
                ${generateDepartmentDropdown(index, item.department)}
                ${generateMonthDateInputs(index, item.months_selected || {})}
            `;
                tableBody.appendChild(row);
            });
        ...
        function generateMonthDateInputs(rowIndex, selectedDates = {}) {
            ...
            <td>
                <input  type="text" class="month-datepicker" data-month="${i}" 
