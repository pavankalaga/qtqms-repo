        ...
        <div x-data="{ showForm: false }">
            <div class="d-flex main-buttons bd-highlight">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="{{ route('download.testfile') }}">
                            <button class="btn-custom-cancel" @click="showForm = false">
                                Download
                            </button>
                        </a>
                    </div>
        ...
        <div class="text-center flex-column">
            ...
            <form wire:submit.prevent="submit">
                ...
                <div class="row mt-5">
                    <!-- Manufacture -->
                    <div class="form-group row">
                        <label for="manufacture" class="col-sm-2 col-form-label">Manufacturer</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control small-placeholder" id="manufacture"
                                placeholder="Manufacturer" wire:model="manufacture">
