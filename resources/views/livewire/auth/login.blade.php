...
<div class="container-fluid">
    <div class="row background-div">
        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center">
            <form wire:submit.prevent="login" class="p-3 rounded shadow bg-white small-form">
                <h2 class="mb-3 text-center login-heading">Welcome, Please Login....</h2>


                <div class="mb-3 row">
                    <label for="username" class="col-form-label col-md-2">Username</label>
                    <div class="col-md-8  ml-auto">
                        <input type="email" wire:model="email" class="form-control" id="username"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8 ml-auto position-relative">
                        <input type="password" wire:model="password" class="form-control" id="password"
                            placeholder="Enter your password">

                        <!-- Eye icons inside the input field -->
                        <span class="field-icon toggle-password" onclick="togglePassword()">
                            <!-- Show Eye (red) -->
                            <i class="fas fa-eye-slash" id="eye-icon" style="color:gray; display:none;"></i>
                            <!-- Hide Eye Slash (blue) -->
                            <i class="far fa-eye" id="eye-slash-icon" style="color:gray;"></i>
                        </span>
