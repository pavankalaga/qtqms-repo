...
<section class="dash-container tab-content">
    <div class="dash-content mt-4">
        ...
        <section id="quotes-section" style="margin-right:30px;">
            <h3 class="title text-center mb-4">My Approvals</h3>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        ...
        <button type="button" class="btn-close btn1" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    ...
    <div class="container my-4">
        ...
        <div id="quotation-section">
            <div class="quotation">
                ...
                <div class="action-buttons">
                    <button class="btn btn-success mx-2 btn1">Escalate</button>
                    <button class="btn btn-success mx-2 btn1">Approve</button>
                    <button class="btn btn-success mx-2 btn1">Deny</button>
                    <button class="btn btn-success mx-2 btn1">More Information</button>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
            <button id="add-section" class="btn btn-success mt-4 btn1">Add Section</button>
        </div>
    </div>
