                              ...
                              <div class="">
                                <div class="row">
                                  ...
                                  <div class="form-group  col-12">
                                    ...
                                    <div data-bs-toggle="modal" data-bs-target="#marketingDialog" class="crdM"><div ><i class="fa-solid fa-cloud mb-2"></i></br> Email Campaign</div></div>
                                    <div data-bs-toggle="modal" data-bs-target="#marketingDialog" class="crdM"><div ><i class="fa-solid fa-cloud mb-2"></i></br> WhatsApp Campaign</div></div>
                                    <div data-bs-toggle="modal" data-bs-target="#marketingDialog" class="crdM"><div><i class="fa-solid fa-cloud mb-2"></i></br> SMS Campaign</div></div>
                                    </div>
                                  </div>
                                  <div class="form-group  col-12">
                                    <label class="col-form-label text-nowrap">Customer Actions</label>
                                    <div>
                                    <div data-bs-toggle="modal" data-bs-target="#marketingDialog" class="crdM"><div>Send Feedback forms</div></div>
...
<script>
     var screen_height = $(window).height() - 136; $('#marketingDialog .modal-body').css({'height': screen_height});
</script>
@endsection