<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::segment(1) == 'lead_tagging' ? 'active' : '' }}">
        <a href="/lead_tagging" class="nav-link">
          <span class="sidebar-text">Lead Tagging</span>
        </a>
      </li>

      <li class="nav-item {{ (Request::segment(1) == 'sales_funnel' || Request::segment(1) == 'opportunity' ) ? 'active' : '' }}">
        <a href="/sales_funnel" class="nav-link">
          <span class="sidebar-text">Opportunity</span>
        </a>
      </li>

      <li class="nav-item {{ Request::segment(1) == 'business' || Request::segment(1) == 'business_statistics' ? 'active' : '' }}">
        <a href="/business" class="nav-link">
          <span class="sidebar-text">Business</span>
        </a>
      </li>

      <li class="nav-item {{ Request::segment(1) == 'sales_call' || Request::segment(1) == 'call-logs' ? 'active' : '' }}">
        <a href="/sales_call" class="nav-link">
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'bootstrap-tables' ? 'show' : '' }}" role="list"
          ...
          <li class="nav-item {{ Request::segment(1) == 'profile' ? 'active' : '' }}">
            ...
            <li class="nav-item {{ Request::segment(1) == 'sales_headquarters' ? 'active' : '' }}">
              <a href="/sales_headquarters" class="nav-link">
                <span class="sidebar-text">Sales HeadQuarters</span>
              </a>
            </li>
          </ul>
        </div>
  ...
  <div class="pl-4  align-items-center" style="
    padding-left: 14px;
    font-size: 17px;
    font-weight: 400;
">
