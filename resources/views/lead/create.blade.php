...
<div id="lead-form-container">
    <form id="lead-form" method="POST" enctype="multipart/form-data">
        @csrf
          <section style="width: calc(100% - 254px);" class="dash-container tab-content">
            <div class="dash-content tab-pane fade show active" id="business-details-tab" role="tabpanel"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="business_type"
                                                                                class="col-form-label text-nowrap required">Business
                                                                                Type: </label>
                                                                            <select id="business_type"
                                                                                ...
                                                                                <option value="Independent Doctor">
                                                                                    Independent Doctor</option>
                                                                                <option
                                                                        ...
                                                                        <div class="form-group   col-lg-4 col-12">
                                                                            ...
                                                                            <select id="legal_business_type"
                                                                                ...
                                                                                <option value="Sole Proprietor">Sole
                                                                                    Proprietor </option>
                                                                            </select> @error('legal_business_type')
                                                                            <span class="text-danger small">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                        <div class="form-group  col-lg-4 col-12">
                                                                            <label for="business_name"
                                                                                class=" whitespace-nowrap col-form-label required">
                                                                        ...
                                                                        <div class="form-group  col-lg-4 col-12">
                                                                            <label for="trading_name"
                                                                                class="col-form-label whitespace-nowrap">
                                                                                Trading Name: </label>
                                                                            <div class="flex-grow">
                                                                                <input type="text" class="form-control"
                                                                                    id="trading_name"
                                                                        ...
                                                                        <div class="form-group  col-lg-4 col-12">
                                                                            <label for="registered_no"
                                                                                class="col-form-label whitespace-nowrap">Registered
                                                                                No: </label>
                                                                            <div class="flex-grow">
                                                                                <input type="text" class="form-control"
                                                                                    id="registered_no"
                                                                                    ...
                                                                                    name="registered_no">
                                                                                @error('registered_no') <span
                                                                                    class="text-red-600 text-sm">{{
                                                                                    $message }}</span> @enderror
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group  col-lg-4 col-12">
                                                                            <label for="registered_no_expiry"
                                                                                class="col-form-label whitespace-nowrap">Registration
                                                                                Expiry : </label>
                                                                            <div class="flex-grow">
                                                                                <input type="date" class="form-control"
                                                                                    id="registered_no_expiry"
                                                                                    name="registered_no_expiry">
                                                                                @error('registered_no_expiry') <span
                                                                                    class="text-red-600 text-sm">{{
                                                                                    $message }}</span> @enderror
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="incorporation_date"
                                                                                class="col-form-label">Incorporation
                                                                                Date:</label>
                                                                            <input type="date" id="incorporation_date"
                                                                                class="form-control"
                                                                                name="incorporation_date">
                                                                            @error('incorporation_date') <span
                                                                                class="text-red-600 text-sm">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="incorporation_no"
                                                                                class="col-form-label">INC No:</label>
                                                                            <input type="number" id="incorporation_no"
                                                                                placeholder="Enter Your Inc No"
                                                                                class="form-control"
                                                                                name="incorporation_no">
                                                                            @error('incorporation_no') <span
                                                                                class="text-red-600 text-sm">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="inc_state"
                                                                                class="col-form-label">INC
                                                                                State:</label>
                                                                        ...
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="pan_no"
                                                                                class="col-form-label">PAN No:</label>
                                                                            <input type="text"
                                                                                class="form-control small-placeholder"
                                                                                id="pan_no"
                                                                                placeholder="Enter Your PAN No"
                                                                                name="pan_no"> @error('pan_no') <span
                                                                                class="text-danger small">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="tan_no"
                                                                                class="col-form-label">TAN No:</label>
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="tan_no"
                                                                                placeholder="Enter Your TAN No"
                                                                                name="tan_no"> @error('tan_no') <span
                                                                                class="text-danger small">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                        <div class="form-group col-lg-4 col-12">
                                                                            <label for="gst_no"
                                                                                class="col-form-label">GST No:</label>
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="gst_no"
                                                                                placeholder="Enter Your GST No"
                                                                                name="gst_no"> @error('gst_no') <span
                                                                                class="text-danger small">{{ $message
                                                                                }}</span> @enderror
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="">
                                                  <div class="row">
                                                    <div class="form-group col-lg-4">
                                                      ...
                                                      <input type="text" class="form-control small-placeholder" id="address1" placeholder="Enter Address" name="address1"> @error('address1') <span class="text-danger small">{{ $message }}</span> @enderror
                                                    </div>
                                                    <div class="form-group col-lg-4">
                                                      <label for="address2" class="col-form-label">Address 2: </label>
                                                      <input type="text" class="form-control small-placeholder" id="address2" placeholder="Enter Address" name="address2"> @error('address2') <span class="text-danger small">{{ $message }}</span> @enderror
                                                    </div>
                                                    <div class="form-group col-lg-4 col-12">
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                          <div class="row">
                                            <div class="form-group col-lg-4 col-12">
                                              ...
                                              <input type="text" class="form-control small-placeholder" id="facebook" placeholder="Enter Facebook URL" name="facebook"> @error('facebook') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="form-group col-lg-4 col-12">
                                              <label for="instagram" class="col-form-label">Instagram: </label>
                                              <input type="text" class="form-control small-placeholder" id="instagram" placeholder="Enter Instagram URL" name="instagram"> @error('instagram') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="form-group col-lg-4 col-12">
                                              <label for="twitter" class="col-form-label">Twitter: </label>
                                              <input type="text" class="form-control small-placeholder" id="twitter" placeholder="Enter Twitter URL" name="twitter"> @error('twitter') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="form-group col-lg-4 col-12">
                                              <label for="linkedin" class="col-form-label">Linkedin: </label>
                                              <input type="text" class="form-control small-placeholder" id="linkedin" placeholder="Enter Linkedin URL" name="linkedin"> @error('linkedin') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                                        ...
                                                        <div class="row new-contact-row">
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="salutation"
                                                                    class="col-form-label">salutation : </label>
                                                                <select id="salutation" class="form-control select2"
                                                                    name="contacts[0][salutation]">
                                                                    <option value="">Select salutation</option>
                                                                    <option value="Dr.">Dr.</option>
                                                                    <option value="Mr.">Mr.</option>
                                                                    <option value="Mrs.">Mrs.</option>
                                                                    <option value="Ms.">Ms.</option>
                                                                </select> @error('contacts[0][salutation]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="first_name" class="col-form-label">First
                                                                    Name</label>
                                                                <input type="first_name"
                                                                    class="form-control small-placeholder"
                                                                    id="first_name" placeholder="Enter First Name"
                                                                    name="contacts[0][first_name]">
                                                                @error('contacts[0][first_name]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-lg-4">
                                                                <label for="last_name" class="col-form-label">Last
                                                                    Name</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder"
                                                                    id="last_name" placeholder="Enter Last Name"
                                                                    name="contacts[0][last_name]">
                                                                @error('contacts[0][last_name]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                ...
                                                                @error('contacts[0][department]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                ...
                                                                @error('contacts[0][designation]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="authority"
                                                                    class="col-form-label">Authority</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder"
                                                                    id="designation" placeholder="Enter Authority"
                                                                    name="contacts[0][authority]">
                                                                @error('contacts[0][authority]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="mobile_no" class="col-form-label">Mobile
                                                                    No</label>
                                                                <input type="number"
                                                                    class="form-control small-placeholder"
                                                                    id="mobile_no" maxlength="10" minlength="10"
                                                                    placeholder="Enter Mobile No."
                                                                    name="contacts[0][mobile_no]">
                                                                @error('contacts[0][mobile_no]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="whats_phone" class="col-form-label">Whatsapp
                                                                    No </label>
                                                                <input type="number" minlength="10" maxlength="10"
                                                                    class="form-control small-placeholder"
                                                                    id="whats_phone" placeholder="Enter Whatsapp Number"
                                                                    name="contacts[0][whats_phone]">
                                                                @error('contacts[0][whats_phone]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="office_phone" class="col-form-label">Office
                                                                    Phone </label>
                                                                <input type="number" minlength="10" maxlength="10"
                                                                    class="form-control small-placeholder"
                                                                    id="office_phone"
                                                                    placeholder="Enter Office Phone Number"
                                                                    name="contacts[0][office_phone]">
                                                                @error('contacts[0][office_phone]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="office_email" class="col-form-label">Office
                                                                    Email</label>
                                                                <input type="email"
                                                                    class="form-control small-placeholder"
                                                                    id="office_email" placeholder="Enter Office Email"
                                                                    name="contacts[0][office_email]">
                                                                @error('contacts[0][office_email]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="personal_email"
                                                                    class="col-form-label">Personal Email</label>
                                                                <input type="email"
                                                                    class="form-control small-placeholder"
                                                                    id="personal_email"
                                                                    placeholder="Enter Personal Email"
                                                                    name="contacts[0][personal_email]">
                                                                @error('contacts[0][personal_email]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="fb_id" class="col-form-label">Facebook
                                                                    Id</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder" id="fb_id"
                                                                    placeholder="Enter Facebook Id"
                                                                    name="contacts[0][fb_id]">
                                                                @error('contacts[0][fb_id]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="insta_id" class="col-form-label">Instagram
                                                                    Id</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder" id="insta_id"
                                                                    placeholder="Enter Instagram Id"
                                                                    name="contacts[0][insta_id]">
                                                                @error('contacts[0][insta_id]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="twitter_id" class="col-form-label">Twitter
                                                                    (X)</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder"
                                                                    id="twitter_id" placeholder="Enter Twitter Id"
                                                                    name="contacts[0][twitter_id]">
                                                                @error('contacts[0][twitter_id]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control small-placeholder"
                                                                    id="linked_id" placeholder="Enter Linkedin Id"
                                                                    name="contacts[0][linked_id]">
                                                                @error('contacts[0][linked_id]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="birthday"
                                                                    class="col-form-label">Birthday</label>
                                                                <input type="date"
                                                                    class="form-control small-placeholder" id="birthday"
                                                                    name="contacts[0][birthday]">
                                                                @error('contacts[0][birthday]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="anniversary"
                                                                    class="col-form-label">Anniversary</label>
                                                                <input type="date"
                                                                    class="form-control small-placeholder"
                                                                    id="anniversary" name="contacts[0][anniversary]">
                                                                @error('contacts[0][anniversary]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="reli_belief"
                                                                    class="col-form-label">Religious Belief</label>
                                                                <input type="text"
                                                                    class="form-control small-placeholder"
                                                                    id="reli_belief"
                                                                    placeholder="Enter Religious Belief"
                                                                    name="contacts[0][reli_belief]">
                                                                @error('contacts[0][reli_belief]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-sm-6 col-lg-4">
                                                                <label for="photo" class="col-form-label">Upload
                                                                    photo</label>
                                                                <input type="file"
                                                                    class="form-control small-placeholder"
                                                                    id="contact_photo"
                                                                    name="contacts[0][contact_photo]">
                                                                @error('contacts[0][contact_photo]') <span
                                                                    class="text-danger small">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                         <div class="form-group col-sm-6 col-lg-4">
                                                    ...
                                                    <div class="row">
                                                        <div>
                                                            <button class="btn btn-outline-dark mt-3"
                                                                id="add_more_contact"
                                                                style="min-width:120px;min-height: 42px;font-size:16px">
                                                    ...
                                                    <div class="">
                                                        <div class="form-group row">
                                                            <label for="remark_description"
                                                                class="col-sm-10 col-form-label">Description</label>
                                                            <div class="col-sm-10">
                                                                <textarea type="text"
                                                                    class="form-control small-placeholder" cols="2"
                                                                    rows="4" id="remark_description"
                                                                    placeholder="Enter details"
                                                                    name="remark_description"></textarea>
            ...
            <div class="dash-content tab-pane fade" id="business-needs-tab" role="tabpanel"
                aria-labelledby="profile-tab">
                <div class="row mb-3">
                    <div class="col-12">
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="row">
                                                        ...
                                                        <div class="inc-id-check d-flex align-items-center gap-3 pt-1">
                                                            <div class="form-check d-flex align-items-center gap-2">
                                                                <input 
                                                                    ...
                                                                    value="yes" 
                                                                    id="inHouseYes"
                                                                    {{ old('in_house_check') === 'yes' ? 'checked' : '' }} 
                                                                />
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label for="lab_departments" class="col-form-label">Lab
                                                        Departments</label>
                                                    <textarea class="form-control" name="lab_departments"></textarea>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="lab_equipments" class="col-form-label">Lab
                                                        Equipments</label>
                                ...
                                <div class="col-md-12">
                                    <div class="card table-card">
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    <label for="inhouse_test_volume" class="col-form-label">Inhouse Test
                                                        Volume per Month</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="inhouse_test_volume" id="inhouse_test_volume">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="outsource_test_volume" class="col-form-label">Outsource
                                                        Test Volume per Month</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="outsource_test_volume" id="outsource_test_volume">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="daily_patient_footfall" class="col-form-label">Daily
                                                        patient Footfall</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="daily_patient_footfall" id="daily_patient_footfall">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="inhouse_test_value" class="col-form-label">Inhouse Test
                                                        Value per Month</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="inhouse_test_value" id="inhouse_test_value">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="outsource_test_value" class="col-form-label">Outsource
                                                        Test Value per Month</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="outsource_test_value" id="outsource_test_value">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="annual_lab_revenue" class="col-form-label">Annual Lab
                                                        Revenue</label>
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="annual_lab_revenue" id="annual_lab_revenue">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="number" class="form-control small-placeholder"
                                                        name="no_of_beds" id="no_of_beds">
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="no_of_doctors" class="col-form-label">No. of
                                                            Doctors</label>
                                                        <div class="">
                                                            <input type="text" class="form-control small-placeholder"
                                                                id="no_of_doctors" placeholder="Enter No. of Doctors"
                                                                name="no_of_doctors"> @error('no_of_doctors')
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="hos_revenue" class="col-form-label">Annual Hospital
                                                            Revenue</label>
                                                        <div class="">
                                                            <input type="text" class="form-control small-placeholder"
                                                                id="hos_revenue" placeholder="Enter hospital revenue"
                                                                name="hos_revenue"> @error('hos_revenue')
                                                            <!-- Validation error for no_of_doctors -->
                                                            <span class="text-danger small">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-12">
                                                            <table
                                                                ...
                                                                id="expected-speciality-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th>S.No</th>
                                                                        <th style="width:30%;max-width:30%">Medical
                                                                            Speciality</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width:30%;max-width:30%">
                                                                            <input type="text"
                                                                                name="expected_speciality[0][speciality_name]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                                                name="expected_speciality[0][doctor_name]"
                                                                                class="form-control">
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="row pt-2">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-check">
                                                        <input 
                                                            ...
                                                            value="speciality" 
                                                            id="speciality" 
                                                            {{ old('category') === 'speciality' ? 'checked' : '' }} 
                                                        />
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <div class="form-check">
                                                        <input 
                                                            ...
                                                            type="radio" 
                                                            name="category" 
                                                            value="super_speciality" 
                                                            id="super_speciality" 
                                                            {{ old('category') === 'super_speciality' ? 'checked' : '' }} 
                                                        />
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="col-sm-12"
                                                            style="max-width:100%;overflow:auto;box-sizing: border-box;">
                                                            <table
                                                                class="table table-bordered align-items-center table-sm"
                                                                id="expected-diagnostic-table"
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th
                                                                            style="max-width:140px;min-width:110px; white-space: normal;">
                                                                            Current Load / month</th>
                                                                        <th>In house</th>
                                                                        <th>Outsource</th>
                                                                        <th style="min-width:190px">Outsource To</th>
                                                                        <th
                                                                            style="max-width:140px;min-width:110px;white-space: normal;text-align: center;">
                                                                            Current L2L Price</th>
                                                                        <th
                                                                            style="max-width:140px;min-width:110px;white-space: normal;text-align: center;">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text"
                                                                                name="expected_business[0][test_name]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][method]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][current_load_month]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <input type="checkbox"
                                                                                name="expected_business[0][inhouse]"
                                                                                style="width:20px;height: 20px;">
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <input type="checkbox"
                                                                                name="expected_business[0][outsource]"
                                                                                style="width:20px;height: 20px;">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][outsource_to]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][current_l2l_price]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][expected_qty_day]"
                                                                                class="form-control">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number"
                                                                                name="expected_business[0][expected_revenue]"
                                                                                class="form-control">
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="row pt-2">
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_1">
                                                </div>
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_2">
                                                </div>
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_3">
                                                </div>
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_4">
                                                </div>
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_5">
                                                </div>
                                                <div class="form-group col-sm-6 col-md-4">
                                                    <input type="text" class="form-control small-placeholder"
                                                        id="challenges_faced" placeholder="Enter Challenges"
                                                        name="challenges_faced_6">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-12 d-flex form-group">
                                                    <div class="col-md-6">
                                                        <label class="col-form-label"
                                                            style="font-size: 20px;text-decoration: underline;text-align: center;width: 100%;margin-bottom: 16px;">
                                                            Weekdays</label>
                                                        <div style="border-right: 1px solid #eee;">
                                                            <div class="col-md-12">
                                                                <div class="form-group d-flex align-items-center gap-2">
                                                                    <label for="no_of_doctors"
                                                                        class="col-form-label">Open timings from</label>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input type="number"
                                                                            class="form-control small-placeholder"
                                                                            id="open_timings_from_week"
                                                                            name="open_timings_from_week"
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input type="number"
                                                                            class="form-control small-placeholder"
                                                                            id="open_timings_to_week"
                                                                            name="open_timings_to_week"
                                                                            style="max-width:65px;max-height: 35px;">
                                                                        <span>PM</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div
                                                                class="col-md-12 form-group d-flex align-items-center gap-2">
                                                                <label for="no_of_pickup_week" class="col-form-label">No
                                                                    of pickup's required</label>
                                                                <input type="number"
                                                                    class="form-control small-placeholder"
                                                                    id="no_of_pickup_week" name="no_of_pickup_week"
                                                                    style="max-width:65px;max-height: 35px;">
                                                                <span>per day</span>
                                                            </div>
                                                            <div
                                                                class="col-md-12 form-group d-flex flex-column align-items-start gap-2">
                                                                <label for="no_of_pickup_1"
                                                                    class="col-form-label">Preferred pickup timings
                                                                </label>
                                                                <div class="d-flex flex-column gap-1">
                                                                    <div
                                                                        class="custom-number d-flex align-items-center gap-2">
                                                                        <label class="col-form-label">1st pickup
                                                                        </label>
                                                                        <div class="position-relative">
                                                                            <input type="number"
                                                                                ...
                                                                                id="no_of_pickup_1"
                                                                                name="no_of_pickup_1"
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                                                                name="business_type_week">
                                                                                <option value="Hospital">AM</option>
                                                                                <option value="Diagnostic Center">PM
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="custom-number d-flex align-items-center gap-2">
                                                                        <label class="col-form-label">2nd pickup
                                                                        </label>
                                                                        <div class="position-relative">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                    ...
                                                                    <div
                                                                        class="custom-number d-flex align-items-center gap-2">
                                                                        <label class="col-form-label">3rd pickup
                                                                        </label>
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                    ...
                                                                    <div
                                                                        class="custom-number d-flex align-items-center gap-2">
                                                                        <label class="col-form-label">4th pickup
                                                                        </label>
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                    ...
                                                                    <div
                                                                        class="custom-number d-flex align-items-center gap-2">
                                                                        <label class="col-form-label">5th pickup
                                                                        </label>
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                    ...
                                                    <div class="col-md-6 ps-3">
                                                        ...
                                                        <div>
                                                            <div class="col-md-12">
                                                                <div class="form-group d-flex align-items-center gap-2">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input type="number"
                                                                            class="form-control small-placeholder"
                                                                            id="open_timings_from_public"
                                                                            name="open_timings_from_public"
                                                                            style="max-width:65px;max-height: 35px;">
                                                                        <span>AM</span>
                                                                    </div>
                                                                    <label for="no_of_doctors"
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input type="number"
                                                                            class="form-control small-placeholder"
                                                                            id="open_timings_to_public"
                                                                            name="open_timings_to_public"
                                                                            style="max-width:65px;max-height: 35px;">
                                                                        <span>PM</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div
                                                                class="col-md-12 form-group d-flex align-items-center gap-2">
                                                                <label for="no_of_pickup_public"
                                                                    class="col-form-label">No of pickup's
                                                                    required</label>
                                                                <input type="number"
                                                                    class="form-control small-placeholder"
                                                                    id="no_of_pickup_public" name="no_of_pickup_public"
                                                                    style="max-width:65px;max-height: 35px;">
                                                                <span>per day</span>
                                                            </div>
                                                            <div
                                                                class="col-md-12 form-group d-flex flex-column align-items-start gap-2">
                                                                <label for="no_of_pickup_public_time"
                                                                    class="col-form-label">Preferred pickup timings
                                                                </label>
                                                                <div class="d-flex flex-column gap-1">
                                                                    <div
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="no_of_pickup_public_1"
                                                                                name="no_of_pickup_public_1" value="{{old('no_of_pickup_public_1')}}" 
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                                                                name="business_type_public">
                                                                                <option value="Hospital">AM</option>
                                                                                <option value="Diagnostic Center">PM
                                                                                </option>
                                                                            </select>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="no_of_pickup_public_2"
                                                                                name="no_of_pickup_public_2" value="{{old('no_of_pickup_public_2')}}"
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="no_of_pickup_public_3"
                                                                                name="no_of_pickup_public_3" value="{{old('no_of_pickup_public_3')}}"
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="no_of_pickup_public_4"
                                                                                name="no_of_pickup_public_4"
                                                                                value="{{old('no_of_pickup_public_4')}}"
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="position-relative ">
                                                                            <input type="number"
                                                                                class="form-control small-placeholder"
                                                                                id="no_of_pickup_public_5"
                                                                                name="no_of_pickup_public_5"
                                                                                value="{{old('no_of_pickup_public_5')}}"
                                                                                style="max-width:100px;padding-right: 40px;">
                                                                            <select id="business_type"
                                                                                name="business_type"
                                                                                class="form-control custom-select"
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="col-12 py-2 d-flex">
                                                <div class="col-6 pt-2">
                                                    <h3 style="font-size:24px;margin-bottom: 16px;">Home Collection
                                                        Requirement</h3>
                                                    <div class="d-flex align-items-center justify-content-between w-80">
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="home_collection" value="{{old('home_collection') === 'yes' ? 'selected' : ''}}" id="flexCheckDefault"
                                                                onclick="toggleCheckbox2(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Definitely Needed </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="home_collection"  value="{{old('home_collection') === 'preferred' ? 'selected' : ''}}"
                                                                id="flexCheckDefault" onclick="toggleCheckbox2(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Preferred </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="home_collection" value="{{old('home_collection') === 'no' ? 'selected' : ''}}"
                                                                id="flexCheckDefault" onclick="toggleCheckbox2(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault"> Not
                                                                Needed </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6 pt-2">
                                                    <h3 style="font-size:24px;margin-bottom: 16px;">IT Integration
                                                        Required</h3>
                                                    <div class="d-flex align-items-center justify-content-between w-80">
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="it_integration" value="{{old('it_integration') === 'yes' ? 'selected' : ''}}"
                                                                 id="flexCheckDefault"
                                                                onclick="toggleCheckbox3(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Definitely Needed </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="it_integration" value="{{old('it_integration') === 'preferred' ? 'selected' : ''}}"
                                                                id="flexCheckDefault" onclick="toggleCheckbox3(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Preferred </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="it_integration" value="{{old('it_integration') === 'no' ? 'selected' : ''}}"
                                                                id="flexCheckDefault" onclick="toggleCheckbox3(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault"> Not
                                                                Needed </label>
                                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card table-card">
                                        <div class="card-body pt-0 table-border-style bg-none">
                                            <div class="col-12 py-2 d-flex">
                                                <div class="col-6 pt-2">
                                                    <h3 style="font-size:24px;margin-bottom: 16px;">NABL Certification
                                                        Requirement</h3>
                                                    <div class="d-flex align-items-center justify-content-between w-80">
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_certificate" value="{{old('nabl_certificate') === 'yes' ? 'selected' : ''}}"
                                                                 id="flexCheckDefault"
                                                                onclick="toggleCheckbox4(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Definitely Needed </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_certificate"
                                                                value="{{old('nabl_certificate') === 'preferred' ? 'selected' : ''}}" id="flexCheckDefault"
                                                                onclick="toggleCheckbox4(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Preferred </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_certificate" value="{{old('nabl_certificate') === 'no' ? 'selected' : ''}}"
                                                ...
                                                <div class="col-6 pt-2">
                                                    <h3 style="font-size:24px;margin-bottom: 16px;">NABL Accreditation
                                                        Required</h3>
                                                    <div class="d-flex align-items-center justify-content-between w-80">
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_accreditation" value="{{old('nabl_accreditation') === 'yes' ? 'selected' : ''}}"
                                                                checked id="flexCheckDefault"
                                                                onclick="toggleCheckbox5(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Definitely Needed </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_accreditation"
                                                                value="{{old('nabl_accreditation') === 'preferred' ? 'selected' : ''}}" id="flexCheckDefault"
                                                                onclick="toggleCheckbox5(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Preferred </label>
                                                        </div>
                                                        <div class="form-check d-flex align-items-center gap-2">
                                                            <input class="form-check-input custom-form-check"
                                                                type="radio" name="nabl_accreditation" value="{{old('nabl_accreditation') === 'no' ? 'selected' : ''}}"
                                                                id="flexCheckDefault" onclick="toggleCheckbox5(this)" />
                                                            <label class="form-check-label" for="flexCheckDefault"> Not
                                                                Needed </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card table-card">
                                        ...
                                        <div class="card-body pt-0 table-border-style bg-none d-flex">
                                            <div class="col-6 mb-0 py-2 d-flex flex-column form-group">
                                                <h3 style="font-size:24px;margin-bottom: 16px;"> Is the Customer TAT
                                                    Sensitive : </h3>
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-80 gap-3">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_tat_sensitive" value="{{old('cus_tat_sensitive') === 'highly' ? 'selected' : ''}}" 
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Highly
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_tat_sensitive" value="{{old('cus_tat_sensitive') === 'moderate' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Moderate
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_tat_sensitive" value="{{old('cus_tat_sensitive') === 'less' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Less
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 mb-0 py-2 d-flex flex-column form-group">
                                                <h3 style="font-size:24px;margin-bottom: 16px;"> Is the Customer willing
                                                    to pay for expedited TAT : </h3>
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-80 gap-3">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_willing_to_pay" value="{{old('cus_willing_to_pay') === 'highly' ? 'selected' : ''}}"
                                                             id="flexCheckDefault"
                                                            onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Highly
                                                        </label>
                                                    ...
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_willing_to_pay" value="{{old('cus_willing_to_pay') === 'moderate' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Moderate
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_willing_to_pay" value="{{old('cus_willing_to_pay') === 'less' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Less
                                                        </label>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card table-card">
                                        <div class="card-body pt-0 table-border-style bg-none d-flex">
                                            <div class="col-6 mb-0 py-2 d-flex flex-column form-group">
                                                <h3 style="font-size:24px;margin-bottom: 16px;"> Is the Customer Quality
                                                    Focus : </h3>
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-80 gap-3">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_quality_focus" value="{{old('cus_quality_focus') === 'highly' ? 'selected' : ''}}" 
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Highly
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_quality_focus" value="{{old('cus_quality_focus') === 'moderate' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Moderate
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_quality_focus" value="{{old('cus_quality_focus') === 'less' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Less
                                                        </label>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card table-card">
                                        <div class="card-body pt-0 table-border-style bg-none d-flex">
                                            <div class="col-6 mb-0 py-2 d-flex flex-column form-group">
                                                <h3 style="font-size:24px;margin-bottom: 16px;"> Is the Customer Price
                                                    Sensitive : </h3>
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-80 gap-3">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_price_sensitive" value="{{old('cus_price_sensitive') === 'highly' ? 'selected' : ''}}"
                                                             id="flexCheckDefault"
                                                            onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Highly
                                                        </label>
                                                    ...
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_price_sensitive" value="{{old('cus_price_sensitive') === 'moderate' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Moderate
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input custom-form-check"
                                                            type="radio" name="cus_price_sensitive" value="{{ old('cus_price_sensitive') === 'less' ? 'selected' : ''}}"
                                                            id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                        <label class="form-check-label" for="flexCheckDefault"> Less
                                                        </label>
                                                    </div>
                                ...
                                <div class="card table-card">
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none">
                                        <div class="row">
                                            ...
                                            <div
                                                class="d-flex align-items-center justify-content-between w-80 gap-3 form-group">
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_preference" value="{{old('payment_preference') === 'cash' ? 'selected' : ''}}"
                                                        id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Cash
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_preference" value="{{old('payment_preference') === 'credit' ? 'selected' : ''}}" id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Credit
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <label class="form-check-label" for="flexCheckDefault"
                                                        style="white-space: nowrap;"> Payment Term</label>
                                                    <input type="number" name="payment_term" value="{{old('payment_term')}}" class="form-control"
                                        ...
                                        <div class="row">
                                            <h3 style="font-size:24px;margin-bottom: 16px;"> Payment Method Preference
                                            </h3>
                                            <div
                                                class="d-flex align-items-center justify-content-between w-80 gap-3 form-group">
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_method" value="{{old('payment_method') === 'bank' ? 'selected' : ''}}" checked id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Bank
                                                        Transfer </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_method" value="{{ old('payment_method') === 'cheque' ? 'selected' : ''}}" id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Cheque
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_method" value="{{ old('payment_method') === 'upi' ? 'selected' : ''}}" id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> UPI </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_method" value="{{ old('payment_method') === 'credit_card' ? 'selected' : ''}}" id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Credit Card
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="payment_method" value="{{ old('payment_method') === 'online_deposit' ? 'selected' : ''}}" id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> Online
                                                        Deposit Via IT Dose </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none">
                                        <div class="row pt-2">
                                            <div
                                                ...
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <label class="form-check-label" for="flexCheckDefault"
                                                        style="margin-right: 50px"> Seeking Volume Discount </label>
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="volume_discount" value="{{ old('volume_discount')}}" checked id="flexCheckDefault"
                                                        onclick="toggleCheckbox4(this)" />
                                                </div>
                                                ...
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <label class="form-check-label" for="flexCheckDefault"
                                                        style="padding-right: 1px"> Expected Volume(Samples) per Month
                                                    </label>
                                                    <input type="text" class="form-control" name="pref_day_samples" value="{{ old('pref_day_samples')}}"
                                                        style="width: 150px" />
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <label class="form-check-label" for="flexCheckDefault"
                                                        style="padding-right: 60px"> Expected Value(Rs) per Month
                                                    </label>
                                                    <input type="text" class="form-control" name="pref_day_rs" value="{{ old('pref_day_rs')}}"
                                                        style="width: 150px" />
                                                </div>
                                    ...
                                    <div class="card-body pt-0 table-border-style bg-none">
                                        <div class="row pt-2">
                                            <div
                                                ...
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="communication_preference" value="{{ old('communication_preference') === 'email' ? 'selected' : ''}}" checked
                                                        id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                ...
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="communication_preference" value="{{ old('communication_preference') === 'phone' ? 'selected' : ''}}"
                                                        id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                ...
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="communication_preference" value="{{ old('communication_preference') === 'sms' ? 'selected' : ''}}"
                                                        id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> SMS </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <input class="form-check-input custom-form-check" type="radio"
                                                        name="communication_preference" value="{{ old('communication_preference') === 'whatsup' ? 'selected' : ''}}"
                                                        id="flexCheckDefault" onclick="toggleCheckbox4(this)" />
                                                    <label class="form-check-label" for="flexCheckDefault"> WhatsApp
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-2">
                                            <h3 style="font-size:24px;margin-bottom: 16px;"> Preferred Meeting Time
                                            </h3>
                                            <div
                                                class="d-flex align-items-center justify-content-between w-80 gap-3 form-group">
                                                <div class="form-check d-flex align-items-center gap-2 ps-0">
                                                    <label class="form-check-label" for="flexCheckDefault"> Day </label>
                                                    <input type="text" style="min-width: 380px;" class="form-control"
                                                        name="pref_meeting_day" value="{{ old('pref_meeting_day')}}" />
                                                </div>
                                                <div class="form-check d-flex align-items-center gap-2">
                                                    <label class="form-check-label" for="flexCheckDefault"> Time
                                                    </label>
                                                    <input type="text" class="form-control" value="{{ old('pref_meeting_time')}}"  name="pref_meeting_time" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
 ...
 <!-- PRICE QUOTES START -->
                                                                        ...
                                                                        <div class="col-6 pe-1">
                                                                            <div class="row">
                                                                                <div class="form-group col-8">
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">Total
                                                                                        Lifetime value</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-8">
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">Revenueble
                                                                                        Summary</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group col-12"
                                                                                ...
                                                                                <input type="radio" class="btn-check rdSbtn"
                                                                                    name="options-outlined"
                                                                                    id="success-outlined" autocomplete="off"
                                                                                    checked>
                                                                                <label
                                                                                    class="btn btn-outline-success rdSbtn"
                                                                                    for="success-outlined">No
                                                                                    Overdue</label>

                                                                                <input type="radio" class="btn-check rdSbtn"
                                                                                    name="options-outlined" id="LTdays"
                                                                                    autocomplete="off">
                                                                                <label
                                                                                    class="btn btn-outline-info rdSbtn gt30Days"
                                                                                    for="LTdays">&gt; 30 Days</label>
                                                                                <input type="radio" class="btn-check rdSbtn"
                                                                                    name="options-outlined" id="30days"
                                                                                    autocomplete="off">
                                                                                <label
                                                                                    class="btn btn-outline-warning rdSbtn gt60Days"
                                                                                    for="30days">&gt; 60 Days</label>
                                                                                <input type="radio" class="btn-check rdSbtn"
                                                                                    name="options-outlined" id="gtdays"
                                                                                    autocomplete="off">
                                                                                <label
                                                                                    class="btn btn-outline-danger rdSbtn gt90Days"
                                                                                    for="gtdays">&gt; 90 Days</label>
                                                                            </div>
                                                                            <div class="table-responsive"
                                                                        ...
                                                                        <div class="col-6 ps-1">
                                                                            <div class="row">
                                                                                <div class="form-group col-5 pe-2 "
                                                                                    ...
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">From</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-6 ps-2">
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">To</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-12 pe-5">
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">Target
                                                                                        Monthly Sale</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-12 pe-5">
                                                                                    <label
                                                                                        class="col-form-label text-nowrap">Actual
                                                                                        Monthly Sale</label>
                                                                                    <input type="text" class="form-control">
                                                                                </div>
                                                                                <div>
    ...
    <div class="dash-content tab-pane fade" id="time-capsule-tab">
        <div role="tabpanel" aria-labelledby="time-capsules-tab">
            <form class="p-4 border rounded shadow-sm bg-light">
                <div class="d-flex align-items-center justify-content-between mb-4 w-100 position-relative"
                    style="background-color:#069acb; border-radius: 5px;">
    ...
    <div class="modal right fade " id="pricebookModal" tabindex="-1" aria-labelledby="pricebookModalLabel"
        aria-hidden="true">
                        ...
                        <div class="container dash-container mt-">
                            <div class="container" style="width:100%;">
                                ...
                                <div class="d-flex mb-4 ms-auto">
                                    <button class="btn btn-success btn1" data-bs-toggle="offcanvas"
                                        data-bs-target="#tableOffcanvas" aria-controls="tableOffcanvas">
                                        Create
                                    </button>
                                </div>
                                <!-- Document Cards -->
                                        ...
                                        <div class="document-card">
                                            ...
                                            <div class="document-container position-relative mb-2">
                                                ...
                                                <div class="document-actions position-absolute bottom-0 mr-5 p-2">
                                                    ...
                                                    <i class="fa-solid fa-eye text-success me-2" data-bs-toggle="modal"
                                                        data-bs-target="#viewModal" onclick="openDocument()"></i>
                                                    <!-- Download icon to download document -->
                                                    <a href="https://via.placeholder.com/150x200.png?text=Document"
                                                        download="dummy-document.png">
                                            ...
                                            <!-- Notes Textarea -->
                                            <textarea class="notes-textarea form-control mt-3"
                            ...
                            <div class="offcanvas offcanvas-end mt-0" tabindex="-1" id="tableOffcanvas"
                                aria-labelledby="tableOffcanvasLabel">
                                <div class="offcanvas-header">
                                ...
                                <div class="offcanvas-body">
                                    <form method="post" enctype="multipart" id="doc_form">
                                        <div class="mb-3">
                                            <label for="choose-file" class="form-label">Choose File:</label>
                                            <input type="file" class="form-control" id="choose-file" name="doc_file">
                                        </div>
                                        <div class="mb-3">
                                            <label for="notes" class="form-label">Notes:</label>
                                            <textarea id="notes" class="form-control" name="doc_notes" 
                                                placeholder="Enter notes..."></textarea>
                                        </div>
                                    </form>
                                        <div class="d-flex justify-content-center">
                                            <button class="btn btn-primary me-2 btn1" id="cancel-btn">Cancel</button>
                                            <button class="btn btn-primary btn1" id="doc_lead_form">Save</button>
                                        </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body notes-body">
                        <div class="dash-container container my-4" style="margin-inline: auto;">
                            ...
                            <!-- Create Notes Button -->
                            <button class="btn btn-success btn1" data-bs-toggle="offcanvas"
                                data-bs-target="#createNotePopup">
                                Create Notes
                            </button>
                            ...
                            <div class="offcanvas offcanvas-end" id="createNotePopup" tabindex="-1">
                                ...
                                <div class="offcanvas-body">
                                    <form method="post" enctype="multipart" id="notes_form">  
                                        <h2 class="mb-2 text-center"> Create Notes</h2>
                                        <div class="mb-3">
                                            <label for="noteTitle" class="mb-2 text-center">Note Title</label>
                                            <input type="text" id="noteTitle" name="note_title" class="form-control" placeholder="Enter title"
                                                required>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="noteDate" class="form-label">Date</label>
                                                <input type="date" id="noteDate" name="note_date" class="form-control" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="noteTime" class="form-label">Time</label>
                                                <input type="time" id="noteTime" name="note_time" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="noteContent" class="form-control" rows="5" name="write_note" 
                                                placeholder="Write your note here..." required></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="uploadFile" class="form-label">Upload Attachments</label>
                                            <input type="file" id="uploadFile" class="form-control" name="note_upload_attch">
                                        </div>
                                    </form>
    ...
    <!-- PROFITABILITY START -->
    <!-- PROFITABILITY START -->
    <div class="modal fade right" id="profitabilityModal" tabindex="-1" aria-labelledby="profitabilityModalLabel"
        aria-hidden="true">
    ...
    <!-- MARKETING START -->
    <div class="modal right fade " id="marketingModal" tabindex="-1" aria-labelledby="marketingModalLabel"
        aria-hidden="true">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="card table-card">
                                                                        ...
                                                                        <div
                                                                            class="card-body pt-0 table-border-style bg-none">
                                                                            <div class="">
                                                                                <div class="row">

                                                                                    <div class="form-group  col-12">
                                                                                        <label
                                                                                            class="col-form-label text-nowrap">Create
                                                                                            Campaign</label>
                                                                                        <div class="d-flex">

                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">
                                                                                                <div><i
                                                                                                        class="fa-solid fa-cloud mb-2"></i></br>
                                                                                                    Email Campaign</div>
                                                                                            </div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                    ...
                                                                                    <div class="form-group  col-12">
                                                                                        <label
                                                                                            class="col-form-label text-nowrap">Customer
                                                                                            Actions</label>
                                                                                        <div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">
                                                                                                <div>Send Feedback forms
                                                                                                </div>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="form-group  col-12">
                                                                                        <label
                                                                                            class="col-form-label text-nowrap">Sales
                                                                                            Boost</label>
                                                                                        <div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">Specials</div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group  col-12">
                                                                                        <label
                                                                                            class="col-form-label text-nowrap">Wishing
                                                                                            on a Special Occassion</label>
                                                                                        <div class="d-flex">
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">Birthday</div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">Anniversary
                                                                                            </div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">Religious</div>
                                                                                            <div data-bs-toggle="modal"
                                                                                                data-bs-target="#marketingDialog"
                                                                                                class="crdM">Special
                                                                                                Occassion</div>
                    ...
                    <div>
                        ...
                        <div class="d-flex" style="margin-top:10px;">
                                ...
                                <div class="row ">
                                    <div class="form-group  col-11">
                                        ...
                                        <select class="form-control" style="margin-top:7px;">
                                            <option value="" disabled selected>Select All the Contacts with Birthdays in the
                                                Month</option>
                                        </select>
                                    </div>
                                    <div class="form-group  col-11">
                                        <select class="form-control">
                                            <option value="" disabled selected>Select All the Contacts with Anniversary in
                                                the Month</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-4">
                                <div class="row">
                                    <div class="form-group  col-12">
                                        <label class="col-form-label text-nowrap" style="padding-top:0px;">Attach Predesign
                                            file</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group  col-12">
                                    ...
                                    <div class="form-group  col-12">
                                        <label class="col-form-label text-nowrap" style="padding-top:0px;">Attach
                                            Deals</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group  col-12">
    ...
    <!-- RELATION SHIP START -->
    <div class="modal right fade " id="relationshipModal" tabindex="-1" aria-labelledby="relationshipModalLabel"
        aria-hidden="true">
        <div class="activityModalcloseBtn" data-bs-dismiss="modal" aria-label="Close">
            X
        </div>
                                                                ...
                                                                <div class="card-body pt-0 table-border-style bg-none">
                                                                    <div class="">
                                                                        <div class="row bdRow">
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label
                                                                                    class="col-form-label text-nowrap">Relationship
                                                                                    Health</label>
                                                                                <input type="text" class="form-control">
                                                                            </div>
                                                                            <div class="form-group   col-lg-4 col-12">
                                                                                <label
                                                                                    class="col-form-label text-nowrap">NPS
                                                                                </label>
                                                                                <input type="text" class="form-control">
                                                                            </div>
                                                                            <div class="form-group  col-lg-4 col-12 d-flex align-items-center"
                                                                                style="padding-top:30px;">
                                                                                <div class="form-check me-4">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox" value="" id="lead">
                                                                                ...
                                                                                <div class="form-check me-4">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox" value="" id="lead">
                                                                                    <label class="form-check-label"
                                                                                        for="lead">Opportunity</label>
                                                                                </div>
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox" value="" id="lead">
                                                                                    <label class="form-check-label"
                                                                                        for="lead">Account</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group   col-lg-4 col-12">
                                                                                <button type="button"
                                                                                    class="btn  btn-small mt-4 acBtn">Account
                                                                                    Status</button>
                                                                            </div>
                                                                        ...
                                                                        <div class="row bdRow">
                                                                            <div class="form-group  col-lg-4 col-12">
                                                                                <label
                                                                                    class="col-form-label whitespace-nowrap">Type
                                                                                    of Customer </label>
                                                                                <div class="flex-grow">
                                                                                    <select class="form-control">
                                                                                        <option> Select</option>
                                                                            ...
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Expectation of
                                                                                    account classification</label>
                                                                                <input type="text" class="form-control">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Referal
                                                                                    Source</label>
                                                                                <input type="text" class="form-control">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                            ...
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">TDPL
                                                                                    Code</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Risk
                                                                                    Profeling</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Lead
                                                                                    Status</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Ownership
                                                                                    Details</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    mandatory Visits per Month</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                        ...
                                                                        <div class="row bdRow">
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Logistics
                                                                                    Route</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Kilometer from
                                                                                    TDPL Lab</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row bdRow">
                                                                            ...
                                                                            <div class="form-group col-lg-4 col-12">
                                                                                <label class="col-form-label">Zonal
                                                                                    Manager</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row bdRow">
                                                                            <div class="col-6">
                                                                                <div class="form-group  col-8">
                                                                                    <label class="col-form-label">Test
                                                                                        classification Received from this
                                                                                        client</label>
                                                                                    <select class="form-control ">
                                                                                        <option value="">Routine</option>
                                                                                        <option value="">Speciality</option>
                                                                                        <option value="">Super Speciality
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <div class="d-flex col-12 mb-2">
                                                                                    <div class="col-5"></div>
                                                                                    <div class="col-3"
                                                                                        style="margin-right:20px;">Quantity
                                                                                    </div>
                                                                                    <div class="col-3">Value</div>
                                                                                </div>
                                                                                <div class="d-flex col-12 mb-2">
                                                                                    <div class="col-5">Customer LifeTime
                                                                                        value</div>
                                                                                    <div class="col-3"
                                                                                ...
                                                                                <div class="d-flex col-12 mb-2">
                                                                                    <div class="col-5">Average sales/Month
                                                                                    </div>
                                                                                    <div class="col-3"
                                                                                        style="margin-right:20px;"><input
                                                                                            type="text"
                                                                                ...
                                                                                <div class="d-flex col-12 mb-2">
                                                                                    <div class="col-5">Increase in Existing
                                                                                        Test Sales</div>
                                                                                    <div class="col-3"
                                                                                        style="margin-right:20px;"><input
                                                                                            type="text"
                                                                                ...
                                                                                <div class="d-flex col-12 mb-2">
                                                                                    <div class="col-5">Increase in New Test
                                                                                        Sales</div>
                                                                                    <div class="col-3"
                                                                                        style="margin-right:20px;"><input
                                                                                            type="text"
                                                                        ...
                                                                        <div class="row bdRow">
                                                                            <div class="form-group col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    Tickets Received</label>
                                                                                <input type="text"
                                                                                    class="form-control fxInp">
                                                                            </div>
                                                                            <div class="form-group  col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    Complaints Received</label>
                                                                                <input type="text"
                                                                                    class="form-control fxInp">
                                                                            </div>
                                                                            <div class="form-group col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    Complaints Resolved</label>
                                                                                <input type="text"
                                                                                    class="form-control fxInp">
                                                                            </div>
                                                                            <div class="form-group  col-12">
                                                                                <label class="col-form-label">Customer
                                                                                    Satisfaction index on Complaint
                                                                                    Resolution</label>
                                                                                <input type="text"
                                                                                    class="form-control fxInp">
                                                                            </div>
                                                                        ...
                                                                        <!-- row start here -->
                                                                        <div class="row bdRow">
                                                                            <div class="mrDSbHd mb-2">Survey feedback
                                                                                Analysis</div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    Customer Participated this year</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Number of
                                                                                    Customer Survey's Participated during
                                                                                    this Lifetime</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Response
                                                                                    Rate</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                            ...
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Net Promoter
                                                                                    Score</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                            ...
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Churn
                                                                                    Prediction Score</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                            <div class="form-group col-lg-6 col-12">
                                                                                <label class="col-form-label">Customer
                                                                                    Lifetime value(CLV) Impact</label>
                                                                                <input type="text" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <!-- row end here -->
...
<style type="text/css">
    ...
    <script type="text/javascript">
       ...
       document.getElementById('add_more_contact').addEventListener('click', function (event) {
        ...
        // Update the name attributes for each input in the new row
        newRow.querySelectorAll('input, select').forEach(function (input) {
            const name = input.getAttribute('name');
            if (name) {
                const updatedName = name.replace(/\[\d+\]/, `[${rowCount}]`);
    ...
    // Handling the remove functionality for each row
    document.getElementById('business-contacts-container').addEventListener('click', function (event) {
        if (event.target.classList.contains('remove-contact-btn')) {
            event.preventDefault();
