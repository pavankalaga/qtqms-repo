...
return new class extends Migration
{
    ...
    {
        Schema::create('annual_supplier_evaluation_forms', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('next_evaluation_date')->nullable();

            $table->unsignedBigInteger('created_by')->nullable();
            $table->unsignedBigInteger('updated_by')->nullable();
            $table->timestamps();

            $table->index('supplier_name', 'ase_supplier_name_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('annual_supplier_evaluation_forms');
    }
};
