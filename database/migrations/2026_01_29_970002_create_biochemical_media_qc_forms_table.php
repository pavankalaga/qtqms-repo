...
return new class extends Migration
{
    ...
    {
        Schema::create('biochemical_media_qc_forms', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['doc_no', 'row_date'], 'biochem_media_qc_docno_date_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('biochemical_media_qc_forms');
    }
};
